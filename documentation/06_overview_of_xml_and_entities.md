...
| **stop.xml** | `SiteFrame` | [StopPlace](07_02_stopplace.md), [Quay](07_03_quay.md) | Authoritative physical stop infrastructure (stations/stop areas and boarding locations). Contains no timetable data. |
| **line_<LineId>.xml** | `ServiceFrame` | [Line](07_04_line.md), [GroupOfLines](07_05_groupoflines.md), [ScheduledStopPoint](07_07_scheduledstoppoint.md), **PassengerStopAssignment**, [StopPointInJourneyPattern](07_08_stoppointinjourneypattern.md), [ServiceJourneyPattern](07_09_servicejourneypattern.md), *(optional)* `ServiceLink` | Logical service structure for one Line. Mapping from logical stops to physical stops is expressed via PassengerStopAssignment. |
|  | `TimetableFrame` | [VehicleJourney](07_10_vehiclejourney.md), [TimetabledPassingTime](07_14_timetabledpassingtime.md), *(optional)* [VehicleJourneyStopAssignment](07_15_vehiclejourneystopassignment.md) | Scheduled journeys and times. VehicleJourneyStopAssignment is only used when quay/platform assignment is known per journey. |
